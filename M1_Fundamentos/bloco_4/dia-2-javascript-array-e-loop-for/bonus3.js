...
Caso não haja próximo valor, a multiplicação deverá ser feita por 2. Faça isso utilizando 
o for e o método push . */
...
for (let index = 0; index < numbers.length; index += 1) {
  if (index === numbers.length -1) {
		novoElemento = numbers[index] * 2;
	} else {
		novoElemento = numbers[index] * numbers[index + 1];
	}
